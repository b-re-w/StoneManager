...
import io.github.irack.stonemanager.ui.style.PulsateEffectButton
...
fun ReconnectionScheduleButton(
    ...
    NeuPulsateEffectFlatButton(
        ...
        Row(
            ...
            ScheduleTimeButton(LS.mainReconnectSchedule, schedulingEnabled, reconnectTimeString,
                openReconnectTimeSelector, Modifier.weight(1f), resizer)
            ScheduleTimeButton(LS.mainDisconnectSchedule, schedulingEnabled, disconnectTimeString,
